...
const API_PATH = '/api/admin/mcp-clients';

const FIELDS = [
  { key: 'name', label: 'Name', required: true, placeholder: 'e.g. Claude Desktop' },
  ...
  { key: 'tags', label: 'Tags (comma-separated)', placeholder: 'desktop, official' },
];
...
export default function AdminMCPClients() {
  ...
  const dialogTitle = crud.dialogMode === 'create' ? 'Add MCP Client' : crud.dialogMode === 'edit' ? 'Edit MCP Client' : 'Delete MCP Client';
