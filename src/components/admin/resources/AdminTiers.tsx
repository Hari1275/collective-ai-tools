...
const API_PATH = '/api/admin/tiers';

const FIELDS = [
  { key: 'name', label: 'Name', required: true, placeholder: 'e.g. Free' },
  { key: 'slug', label: 'Slug', required: true, placeholder: 'e.g. free' },
...
export default function AdminTiers() {
  ...
  const dialogTitle = crud.dialogMode === 'create' ? 'Add Pricing Tier' : crud.dialogMode === 'edit' ? 'Edit Pricing Tier' : 'Delete Pricing Tier';
