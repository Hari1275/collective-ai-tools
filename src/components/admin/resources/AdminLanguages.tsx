...
const API_PATH = '/api/admin/languages';

const FIELDS = [
  { key: 'name', label: 'Name', required: true, placeholder: 'e.g. Python' },
  { key: 'slug', label: 'Slug', required: true, placeholder: 'e.g. python' },
];
...
export default function AdminLanguages() {
  ...
  const dialogTitle = crud.dialogMode === 'create' ? 'Add Language' : crud.dialogMode === 'edit' ? 'Edit Language' : 'Delete Language';
