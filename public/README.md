...
- [Agent Island](https://github.com/tristan666666/agent-island) - Free, MIT-licensed native companion for Claude Code, Codex, Antigravity, Grok, and Cursor, with local session status, your-turn alerts, and provider usage views. `#free` `#opensource`
